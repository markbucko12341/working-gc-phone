...
RegisterNUICallback('send', function(data)
    ...
    TriggerEvent("pNotify:SendNotification", {text = "Message Sent", type = "success", timeout = 1400, layout = "centerLeft"})
end)
...
Citizen.CreateThread(function()
    ...
    if #alerts ~= 0 then
      ...
      if alert.isAccept == 0 then
        AddTextComponentString('~o~Calls in progress')
      else
        AddTextComponentString('~g~Calls in progress')
      end
      DrawText(0.12, 0.02)
      ...
      SetTextColour(255, 255, 255, 255)
      SetTextEntry("STRING")
      AddTextComponentString(alert.isAccept .. ' Units')
      DrawText(0.195, 0.02)
      ...
      SetTextColour(255, 255, 255, 255)
      SetTextEntry("STRING")
      AddTextComponentString('Please press ~g~Y~s~ to take call or ~r~N~s~ to refuse call.')
      DrawText(0.025, 0.16)
      ...
      if alert.message ~= nil then
        ...
        SetTextColour(255, 255, 255, 255)
        SetTextEntry("STRING")
        AddTextComponentString("~o~No Message")
        DrawText(0.12, 0.08)
      end
      ...
      if alert.coords ~= nil then
        ...
        SetTextColour(255, 255, 255, 255)
        SetTextEntry("STRING")
        AddTextComponentString('~o~Unknown Position')
        DrawText(0.12, 0.14)
      end
      ...
      if alert.numero ~= nil then
        ...
        SetTextColour(255, 255, 255, 255)
        SetTextEntry("STRING")
        AddTextComponentString('~g~Number: ~b~' .. alert.numero)
        DrawText(0.17, 0.14)
      else 
        SetTextFont(0)
        SetTextScale(0.0, 0.24)
        ...
        SetTextColour(255, 255, 255, 255)
        SetTextEntry("STRING")
        AddTextComponentString('~o~Unknown Number')
        DrawText(0.17, 0.14)
      end
